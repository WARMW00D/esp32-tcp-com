...
> 🤖 The firmware and web portal were built together with **Claude** (Anthropic) — from the first version of the bridge to the final security setup, dark theme, and WPA2-Enterprise support.
...
- The session password and Wi-Fi/Enterprise passwords are transmitted/stored without encryption — this is meant for a trusted local network, not for direct exposure to the internet.
